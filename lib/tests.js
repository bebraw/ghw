...
suite(matchToHTML(t.regular_link), {
    '[foo](bar)': '<a href="bar">foo</a>'
});
...
suite(matchToHTML(t.pure_link_begin), {
...
suite(matchToHTML(t.pure_link_end), {
    'Audio: https://github.com/ofmlabs': 'Audio: [github.com/ofmlabs](https://github.com/ofmlabs)',
    'HTML-HTML_: https://foo-fo_o.com, http://bar.com': 'HTML-HTML_: [foo-fo_o.com](https://foo-fo_o.com), [bar.com](http://bar.com)',
    'foo': 'foo'
});
